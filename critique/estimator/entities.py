...
from src.critique.estimator import coco
...
class Human:
    ...
    def get_face_box(self, img_w, img_h, mode=0):
        ...
        _NOSE = coco.CocoPart.Nose.value
        _NECK = coco.CocoPart.Neck.value
        _REye = coco.CocoPart.REye.value
        _LEye = coco.CocoPart.LEye.value
        _REar = coco.CocoPart.REar.value
        _LEar = coco.CocoPart.LEar.value
    ...
    def get_upper_body_box(self, img_w, img_h):
        ...
        _NOSE = coco.CocoPart.Nose.value
        _NECK = coco.CocoPart.Neck.value
        _RSHOULDER = coco.CocoPart.RShoulder.value
        _LSHOULDER = coco.CocoPart.LShoulder.value
...
class BodyPart:
    ...
    def get_part_name(self):
        return coco.CocoPart(self.part_idx)
